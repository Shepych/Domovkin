<header>
    <section class="grid flex main__header__row" style="height: 100px">
        ...
        <a class="logo" href="/">DOMOVKIN<span style="color: #126eff">.RU</span></a>
        ...
        <a style="margin-left: 24px;margin-top: 6px;" href="{{ route('client.auth') }}">
    ...
    <section class="main__menu">
        <ul class="flex">
            <li class="flex {{ request()->is('articles/*') || request()->is('articles') ? 'main__menu__active' : null }}"><a class="flex" href="{{ route('articles') }}"><span>Статьи</span></a></li>
            <li class="flex {{ request()->is('project/*') || request()->is('/') ? 'main__menu__active' : null }}"><a class="flex" href="{{ route('index') }}"><span>Объекты</span></a></li>
