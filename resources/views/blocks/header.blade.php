<header>
    <section class="grid flex main__header__row" style="height: 100px;max-width:1600px">
        ...
        <div style="position:relative; display: flex;flex-direction:column;justify-content:center;align-items:center">
            ...
            <span class="lozung" style="color: white">Строительство коттеджей, бань, гаражей, беседок под ключ в Москве и Московской области. Ремонт квартир и домов</span>
        </div>

        <button class="button request__call" style="height: 50px;margin-left: 24px;" onclick="application()">Заказать звонок</button>

        <span style="display: block;text-align: center" class="phone">8&nbsp;<span class="gray__char">(</span>812<span class="gray__char">)</span>&nbsp;900 <span class="gray__char gray__char__deffis">-</span> 08<span class="gray__char gray__char__deffis">-</span>40</span>
        
        <a class="user__icon" style="margin-left: 19px;margin-top: 6px;" href="{{ route('login') }}">
